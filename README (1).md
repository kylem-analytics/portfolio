...
### [SWAT Project Pipeline Dashboard](swat-steerco-dashboard/)

A Power BI dashboard simulating an internal project-intake and delivery-tracking system built on a five-stage operating model (intake, build, governance, testing, deployment), with automated bottleneck detection, proportional aging analysis, and a steering-committee-ready review view. Built collaboratively with Claude (Anthropic) as a hands-on demonstration of AI-assisted analytics development, from the underlying Python data model through every DAX measure.

**Highlights:** Correctly identified Testing, not the naturally-longer Governance stage, as the actual proportional bottleneck (70% vs. 50% of typical stage duration used) by rejecting a raw-average measure that would have misidentified it. 41 of 72 mock projects flagged for executive review, broken into three mutually exclusive categories (priority-only, schedule-only, both) that sum exactly to the total.

**Tools:** Python (pandas, Faker), Power BI, DAX
...
**Programming & Analytics:** Python, SQL, Tableau, Power BI, DAX, Advanced Excel, Bloomberg Terminal

**Finance:** Equity Valuation, DCF Modeling, Financial Statement Analysis, Real Estate Underwriting, FP&A, Investment Research

**Data Science:** Statistical Modeling, Regression Analysis, Machine Learning, Data Visualization, Dashboard Development, Synthetic Data Generation

**AI-Assisted Development:** Prompt Engineering, AI-Assisted Data Modeling & Analytics (Claude)
